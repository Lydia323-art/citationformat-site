...
function renderPrivacyPage() {
  legalShell({
    ...
    body: `
      ...
      <div class="content-card"><h2>Analytics</h2><p>The site uses Google Analytics 4 and Microsoft Clarity to understand aggregate usage patterns, traffic sources, page interactions, and technical issues. These tools may collect usage data such as page views, clicks, scrolling, device/browser information, and approximate location derived from network data. Citation text is not saved by this site.</p></div>
...
function renderCookiePolicyPage() {
  legalShell({
    ...
    body: `
      ...
      <div class="content-card"><h2>Analytics cookies</h2><p>Google Analytics 4 and Microsoft Clarity are enabled to help us understand page usage and improve the citation tool. These services may use cookies or similar technologies for analytics, session insights, and fraud prevention. You can limit cookies through your browser settings.</p></div>
